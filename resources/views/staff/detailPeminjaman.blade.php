...
@section('content')
    <div class="mx-auto w-full min-h-[100vh] flex">
        ...
        <div class="w-3/4 mx-12 my-8 px-8 py-4 bg-white rounded-lg">
            <a href="{{ route('staff.table') }}" class="text-sm text-gray-500 hover:underline block mb-4">
                ...
                <div class="flex justify-between gap-2">
                    ...
                    <div class="flex-1 flex flex-col gap-3">
                        ...
                        <div class="flex gap-12 items-center">
                            ...
                            <form action="{{ route('staff.updateStatus', $data->id) }}" method="POST">
                                @csrf
    ...
    <script>
        $(document).ready(function() {
            $('#status').on('change', function() {
                ...
                $.ajax({
                    url: "{{ route('staff.updateStatus', '') }}/" + id,
                    method: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
                        status: status
